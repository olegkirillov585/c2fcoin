Contributing to C2FCoin Core
============================

The C2FCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the C2FCoin Core project, and is not to be
confused with overall C2FCoin Network Protocol consensus changes.

Whether a pull request is merged into C2FCoin Core rests with the project merge
...
Patches that change C2FCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the C2FCoin consensus, it must have been
...
The project leader is the release manager for each C2FCoin Core release.
