...
RESOURCES += src/qt/c2fcoin.qrc src/qt/c2fcoin_locale.qrc

TRANSLATIONS += src/qt/locale/c2fcoin_bg.ts \
                src/qt/locale/c2fcoin_de.ts \
                src/qt/locale/c2fcoin_en.ts \
                src/qt/locale/c2fcoin_es.ts \
                src/qt/locale/c2fcoin_fi.ts \
                src/qt/locale/c2fcoin_fr.ts \
                src/qt/locale/c2fcoin_it.ts \
                src/qt/locale/c2fcoin_ja.ts \
                src/qt/locale/c2fcoin_pl.ts \
                src/qt/locale/c2fcoin_pt.ts \
                src/qt/locale/c2fcoin_ru.ts \
                src/qt/locale/c2fcoin_sk.ts \
                src/qt/locale/c2fcoin_sv.ts \
                src/qt/locale/c2fcoin_vi.ts \
                src/qt/locale/c2fcoin_zh_CN.ts \
                src/qt/locale/c2fcoin_zh_TW.ts
