...
/** 
    ...
    ****Note - for C2FCoin we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of c2fcoin coming in to a transaction
