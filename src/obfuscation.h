...
{
public:
    /// Is the inputs associated with this public key? (and there is 10000 C2F - checking if valid masternode)
    ...
    /// Verify the message, returns true if successful
...
public:
    ...
    /// Get the denominations for a specific amount of c2fcoin.
