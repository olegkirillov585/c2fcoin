...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("C2FCoin Core c2fcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  c2fcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded c2fcoin transaction") + "\n" +
                               "  c2fcoin-tx [options] -create [commands]   " + _("Create hex-encoded c2fcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded c2fcoin transaction
