...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    StartShutdown();
    return "C2FCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* C2FCoin features */
        {"c2fcoin", "masternode", &masternode, true, true, false},
        {"c2fcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"c2fcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"c2fcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"c2fcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"c2fcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"c2fcoin", "startmasternode", &startmasternode, true, true, false},
        {"c2fcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"c2fcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"c2fcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"c2fcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"c2fcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"c2fcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"c2fcoin", "mnbudget", &mnbudget, true, true, false},
        {"c2fcoin", "preparebudget", &preparebudget, true, true, false},
        {"c2fcoin", "submitbudget", &submitbudget, true, true, false},
        {"c2fcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"c2fcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"c2fcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"c2fcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"c2fcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"c2fcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"c2fcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"c2fcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"c2fcoin", "mnsync", &mnsync, true, true, false},
        {"c2fcoin", "spork", &spork, true, true, false},
        {"c2fcoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"c2fcoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
{
    return "> c2fcoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:13141/\n";
}
