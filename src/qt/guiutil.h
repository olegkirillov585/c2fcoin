...
/** Utility functions used by the C2FCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render C2FCoin addresses in monospace font
...
// Parse "c2fcoin:" URI into recipient object, return true on successful parsing
