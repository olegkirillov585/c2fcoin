                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("C2FCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a C2FCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and c2fcoin: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zC2F"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About C2FCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about C2FCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for C2FCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your C2FCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified C2FCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a C2FCoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the C2FCoin Core help message to get a list with possible C2FCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("C2FCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to C2FCoin network", "", count));
}
...
{
    QString strTitle = tr("C2FCoin Core"); // default title
