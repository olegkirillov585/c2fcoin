...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::C2F);
    ...
    if (!settings.contains("nAnonymizeC2FCoinAmount"))
        settings.setValue("nAnonymizeC2FCoinAmount", 1000);

    nAnonymizeC2FCoinAmount = settings.value("nAnonymizeC2FCoinAmount").toLongLong();
...
// Wallet
    ...
    if (settings.contains("nAnonymizeC2FCoinAmount"))
        SoftSetArg("-anonymizec2fcoinamount", settings.value("nAnonymizeC2FCoinAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in c2fcoin.cpp during shotdown to also remove the window positions
...
QVariant OptionsModel::data(const QModelIndex& index, int role) const
{
    if (role == Qt::EditRole) {
        ...
        case AnonymizeC2FCoinAmount:
            return QVariant(nAnonymizeC2FCoinAmount);
        case Listen:
...
bool OptionsModel::setData(const QModelIndex& index, const QVariant& value, int role)
{
    ...
    if (role == Qt::EditRole) {
        ...
        case AnonymizeC2FCoinAmount:
            nAnonymizeC2FCoinAmount = value.toInt();
            settings.setValue("nAnonymizeC2FCoinAmount", nAnonymizeC2FCoinAmount);
            emit anonymizeC2FCoinAmountChanged(nAnonymizeC2FCoinAmount);
            break;
        case CoinControlFeatures:
