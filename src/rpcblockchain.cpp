...
UniValue getrawmempool(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "    \"fee\" : n,              (numeric) transaction fee in c2fcoin\n"
...
UniValue getblock(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "  \"zC2Fsupply\" :\n"
            "  {\n"
            "     \"1\" : n,            (numeric) supply of 1 zC2F denomination\n"
            "     \"5\" : n,            (numeric) supply of 5 zC2F denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 zC2F denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 zC2F denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 zC2F denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 zC2F denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 zC2F denomination\n"
            "     \"5000\" : n,         (numeric) supply of 5000 zC2F denomination\n"
            "     \"total\" : n,        (numeric) The total supply of all zC2F denominations\n"
            "  }\n"
            "}\n"
            "\nResult (for verbose=false):\n"
...
UniValue gettxout(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 3)
        throw runtime_error(
            ...
            "     \"addresses\" : [          (array of string) array of c2fcoin addresses\n"
            "     \"c2fcoinaddress\"   	 	(string) c2fcoin address\n"
            "        ,...\n"
            "     ]\n"
            "  },\n"
