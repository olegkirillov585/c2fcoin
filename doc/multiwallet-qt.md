...
In order to support loading of multiple wallets in c2fcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is c2fcoin.cpp.
...
Changes to c2fcoin.cpp
----------------------
c2fcoin.cpp is the entry point into c2fcoin-qt, and as such, will require some minor modifications to provide hooks for
